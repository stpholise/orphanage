                ...
                <div className="flex md:flex-row flex-col md:gap-11 lg:gap-16 items-center justify-between">
                    <div className="flex flex-col gap-5 md:gap-5 lg:gap-9 lg:h-[460px]">
                        <div className="flex items-center justify-start gap-3 md:gap-5 font-bold">
                            <div className="border w-9  md:w-12 lg:w-20 border-gray-700"></div> <h4>KNOW ABOUT US</h4>
                        </div>
                        <div className=" md:ml-16 lg:ml-24 lg:w-[607px] flex flex-col gap-4 lg:gap-8">
                            <h2 className=" md:text-4xl lg:text-5xl"> We provide a place for children with special needs</h2>
                            ...
                            <button className=' h-9 w-28 md:h-12 md:w-36 bg-[#F2C94C] rounded-sm'> Learn more</button>
                        </div>
                    </div>
                    <div className=' hidden md:flex justify-center items-center w-full bg-[] '>
                        <Image 
                            ...
                            width='100'
                            height='100'
                            className='lg:w-[444px] lg:h-[550px] md:h-96 md:min-w-72 md:w-80 w-7/12 h-68 rounded-3xl border-2 border-red-200'
                        />
                    </div>
                </div>
            ...
            <div className="container mx-auto flex flex-col gap-24 lg:px-8 px-4 py-9 md:py-12 lg:py-14">
                <div className="flex lg:gap-16 items-center">
                    <div className="flex flex-col gap-5 md:gap-6 lg:gap-9 min-h-[460px]">
                        <div className="flex items-center justify-start gap-3 md:gap-5 font-bold">
                            <div className="border w-9 md:w-12 lg:w-20 border-gray-700"></div> <h4>WHAT WE DO</h4>
                        </div>
                        <div className=" md:ml-16 lg:ml-24 lg:w-[607px] flex flex-col gap-3 md:gap-4 lg:gap-8">
                            <h2 className=" text-3xl sm:text-4xl md:text-5xl font-medium lg:font-bold"> Some services we provide for our children</h2>
                            <p className="">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. </p> 
                            <div className=" flex flex-col gap-5 px-4 md:px-8 border-l-2 border-gray-400">
                                    {
                                        services.map((item, index) => (
                                            <div key={index} className="flex gap-3 md:gap-6 lg:gap-8 justify-start">
                                                <div className="w-9 ">
                                                    <Image 
                                                        src={`${item.icon}`}
                                                        alt={item.title}
            ...
            <div className="container mx-auto flex flex-col gap-9 md:gap-12 lg:px-8 px-4 py-9 md:py-12 lg:py-14">
                <div className="flex gap-9 md:gap-12 lg:gap-16 items-center">
                    <div className="flex flex-col gap-9  ">
                        <div className="flex items-center justify-start gap-5 font-bold uppercase"><div className="border w-9 md:w-12 lg:w-20 border-gray-70"></div> <h4>Projects we have done</h4></div>
                        <div className=" ml-2 lg:w-[607px] flex flex-col gap-8">
                            <h2 className=" text-3xl sm:text-4xl md:text-5xl font-bold">We are creating a place where children with special needs can thrive</h2> 
                        </div>
                    </div> 
                </div>
                ...
                <div className="flex flex-col gap-5  md:gap-9 md:flex-row w-full lg:gap-16 items-center justify-between">
                    <div className="flex flex-col gap-3 md:gap-9  "> 
                        <div className=" md:w-96 lg:w-[607px] flex flex-col gap-8">
                            <h2 className="lg:text-5xl md:text-4xl font-bold">How we spend your donations and where it goes</h2> 
                            ...
                            <div className="flex items-center flex-wrap gap-x-9 gap-y-4 text-sm ">
                                {
                                    chartData.map((item, index) => (
                                        <div key={index} className="flex items-center gap-4  ">
                                            <div className={cn('w-4 h-4', item.color ? `bg-[${item.color}]` : '')}  > 
                                                </div> <p className='whitespace-nowrap '>  {item.value}% {item.title}</p></div>
                                    ))
                                }
                            </div>
                        </div>
                ...
                <div className="flex w-full lg:gap-16 items-center justify-center bg-[url('/Images/BG-Image.jpg')] bg-cover h-72 py-9 md:h-96 rounded-lg ">
                    <div className={`flex flex-col px-4 items-center justify-center w-full md:w-[760px] md:px-4  gap-9 `}>
                       ...
                       <div className=" flex flex-col xs:flex-row items-center justify-center gap-4"> 
                            <button className='bg-[#F2C94C] w-44 md:w-52 h-12 rounded-sm'>Join as a volunteer</button>
                            <button className="bg-white  text-black w-28 md:w-36 h-12 rounded-sm">Donate</button>
                        </div>
                    </div>
                ...
                <div className="container mx-auto flex flex-col gap-6">
                    ...
                    <div className="flex sm:flex-row flex-col gap-6 sm:gap-7 justify-center">
                        <div className="flex bg-[#F2C94C] h-40  p-9  gap-3 md:gap-4 rounded-xl w-full ">
                                ...
                                <div className="">
                                    <div className="text-sm uppercase flex items-center gap-2 md:gap-5"> Next Event <div className="border-b border-black w-12"></div></div>
                                    <div className=" text-base md:text-2xl font-semibold">A day with our wonderful children </div>
                                </div>
                        </div>
                        <div className="flex gap-4 bg-[#F2C94C] h-40  p-9 rounded-xl w-full ">
                                ...
                                <div className="">
                                    <div className="text-sm uppercase flex items-center gap-2 md:gap-5"> Next Event <div className="border-b w-12 border-black"></div></div>
                                    <div className=" text-base md:text-2xl font-semibold">Seminar: Caring for children with autism</div>
                                </div>
                        </div> 
                    </div>
                </div>
