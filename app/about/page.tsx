...
const page = () => {
  return (
    <div>
      <div className="container lg:mt-12 md:mt-10 mx-auto lg:px-8 md:px-6 sm:px-4 flex flex-col md:gap-8 lg:gap-10 xl:gap-12">
        <div className="flex gap-4 justify-between  lg:py-0 md:py-8">
          <SectionHeading
            title="know about us"
            heading=" We are a non-governmental organization"
          />

          <div className="flex flex-col justify-center md:gap-3 lg:gap-4  w-full xl:w-[464px] lg:w-[550px]">
      ...
      <div className="xl:h-[1050px] relative my-4  ">
        ...
        <div className="xl:h-[780px] xl:pt-66 lg:pb-12 md:pb-10 xl:pb-4 lg:pt-56 md:pt-52 w-full bg-[#FCEDC6]">
          <div className="container mx-auto lg:px-8 md:px-6 lg:gap-16 md:gap-12 xl:gap-24 px-4   md:flex  justify-center">
      ...
      <div className=" container mx-auto my-8 lg:px-8 md:px-6 px-4 ">
        <div className="bg-[#F2C94C] xl:h-[576px] lg:h-[444px] md:h-96 flex gap-8 items-center md:py-8 lg:py-10 xl:py-12 md:px-6 lg:px-8 rounded-2xl ">
          <div className="lg:px-8 md:px-3 flex items-center lg:gap-8 ">
            <div className="md:w-96 lg:w-[444px] flex flex-col lg:gap-6 md:gap-4 lg:justify-center">
              ...
              <div className=" flex justify-start md:gap-5 lg:gap-8">
                <div className="">
          ...
          <div className="">
            <Image
              ...
              width="100"
              height="100"
              className="lg:w-[600px] xl:h-[444px] lg:h-80 md:h-72 md:w-72"
            />
          </div>
        </div>
      </div>
