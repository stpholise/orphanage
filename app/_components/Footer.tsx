...
const Footer = () => {
  ...
  return (
    <div className='bg-black'>
        <div className="container mx-auto lg:px-8 px-4 lg:py-16 flex gap-24">
            <div className="logo">
                <p className='text-white font-bold'><span>largerthan</span> <span className={`${courgette.className}`}>i</span></p>
            </div>
