...
const EventWrapper = () => {
  return (
    <div className="xl:w-[590px]  lg:w-[560px] h-fit md:w-96 bg-white dark:bg-gray-900 rounded-3xl xl:p-8 lg:p-5 m flex sm:flex-row flex-col md:flex-col md:p-4 gap-4 p-4 md:gap-6 ">
