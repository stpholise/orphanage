...
const ProjectCard = ({projectTitle, projectDescription}: Project) => {
  useAOS(); 
  return (
    <div  data-aos="flip-left"   className="lg:p-12 px-6 py-8 md:p-8 bg-[url('/Images/BG-Image.jpg')]  rounded-3xl text-white flex flex-col h-72  md:h-96 lg:h-[444px] justify-between">
