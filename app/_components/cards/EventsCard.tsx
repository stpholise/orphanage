  ...
  return (
      <div className="lg:min-h-40 flex md:flex-row xs:flex-row flex-col sm:flex-col gap-4 xl:gap-6 lg:gap-4 xl:items-start lg:items-start">
          ...
          <div className=" flex flex-col items-start justify-center xl:gap-3 lg:gap-1 gap-1.5">
              <h2 className=" "> <Link href='#' className="lg:text-lg text-lg font-bold dark:text-white"> {title}</Link></h2>
              <h5 className="text-[#1D2130] dark:text-gray-400 text-sm">{date}</h5>
              <p className="text-[#525560] dark:text-gray-300">{information}</p>
          </div>
    </div>
  )
}
